...
public partial class Character : NetworkBehaviour, IBeforeAllTicks
{
    [Header("Controls")]
    ...
    public override void Render()
    {
        ...
        foreach (var change in _changeDetector.DetectChanges(this))
        {
            ...
            else if (change == nameof(NetBlacksmithRevision))
            {
                BlacksmithNetworkOnRenderChange(change);
            }
